                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-xs-12">
                    <div class="card sales-card">
                        <div class="row">
                            ...
                            <div class="col-4">
                                <img style="height: 100%;width:100%" src ="{{ asset('assets/img/visitor/image2.png') }}">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-12 col-lg-12 col-md-12 col-xs-12">
                    <div class="card sales-card">
                        <div class="row">
                            ...
                            <div class="col-4">
                                <img style="height: 100%;width:100%" src ="{{ asset('assets/img/visitor/image3.png') }}">
                            </div>
                        </div>
                    </div>
                </div>
...
@section('scripts')
    <script>
        ...
        function startIntervals() {
            ...
            }, 20000); // 15 seconds interval for the second section

            setInterval(() => {
                updateCounter('singha-up2', 'card3', sirenSound);
            }, 25000); // 20 seconds interval for the third section

            setInterval(() => {
                updateCounter('singha-up3', 'card4', sirenSound);
            }, 15000); // 25 seconds interval for the fourth section
        }
